...
import com.Webprac.DAO.CommonDAOInterface;
...
@Repository
public abstract class CommonDAO<T extends CommonEntity<ID>, ID extends Serializable> implements CommonDAOInterface<T, ID> {
